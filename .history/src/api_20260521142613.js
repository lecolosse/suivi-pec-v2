...
export var api = {
  ...
  configureMonth: function(id, month, status, manualClose) { return apiCall('/partenariats/' + id + '/month-config', { method: 'PUT', body: JSON.stringify({ month: month, status: status, manualClose: manualClose }) }); },
};
