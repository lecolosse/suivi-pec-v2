  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex justify-end gap-3 pt-2" style={{paddingBottom:24}}>
        ...
        <button type="submit" className="bg-indigo-600 text-white rounded-lg px-5 py-3 text-sm font-medium" style={{border:'none'}}>✅ Créer</button>
      </div>
    </form>
  );
}
